  ...
  return (
    <Layout>
      ...
      <div className="md:w-3/5 md:pl-8">
        ...
        >
          Hi, my name is <span className="text-darkPurple">Hamid Raza</span>
        </motion.h1>
        ...
        >
          ...
          Development. Currently employed in SoftwareAG, working on a IOT
          plateform. I'm specialized in Angular, ReactJS, JavaScript, HTML/CSS
          on the frontend, but I'm pretty comfortable with MongoDB, NodeJs and
          Express.
        </motion.p>
      </div>
